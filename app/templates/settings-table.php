			...
			<td colspan="4">
				<table class="widefat edit-table">
					...
					<tr>
						...
						<td>
							<textarea name="keyword_filter" id="post_template" cols="30" rows="10"><?php
					...
					<tr>
						...
						<td>
							...
							<input type="submit" value="Purge Cache" name="purge_deleted_cache" class="button button-primary button-large" />
						</td>
					</tr>
					<?php } ?>
					<tr>
						...
						<td>
							<input type="submit" value="Export your Feeds and Setting as CSV File" name="csv_download" class="button button-primary button-large" />
						</td>
					</tr>
					<tr>
						<td>
...
strip_html = strip html tags - "true" or "false"', "rss-post-importer"); ?></p>
					...
					<tr>
						...
						<td>
							<input type="submit" value="Export your Feeds as OPML File" name="export_opml" class="button button-primary button-large" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="file" name="import_opml" />
						</td>
					</tr>
