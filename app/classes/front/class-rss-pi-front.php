        ...
        if($this->options['settings']['tw_show']==1){
            if(is_single()) {
                ...
                if(has_post_thumbnail($post->ID)) {
                    ...
                    $tc_image_thumb = 'https://pbs.twimg.com/profile_images/1271220543950372876/HDlfu8z-_400x400.jpg';
                }
                echo '<meta name="twitter:card" value="summary" />';
                echo '<meta name="twitter:site" value="@L70Media" />';
                ...
                echo '<meta name="twitter:creator" value="@L70Media" />';
            }
        }
    }
